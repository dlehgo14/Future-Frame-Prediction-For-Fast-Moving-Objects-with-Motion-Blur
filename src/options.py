...
class TrainOptions():
  def __init__(self):
    ...
    # data loader related
    self.parser.add_argument('--visualize_root', type=str, required=True, help='saved path of data visualized')
    self.parser.add_argument('--group_train', action='store_true', required=False, help='saved path of data visualized')
    self.parser.add_argument('--test_mode', action='store_true', required=False, help='saved path of data visualized')
    self.parser.add_argument('--multi_gpu', action='store_true', required=False, help='saved path of data visualized')
    self.parser.add_argument('--sequence_num', type=int, default=60, required=False, help='saved path of data visualized')
    self.parser.add_argument('--dataroot', type=str, required=True, help='path of data')
    self.parser.add_argument('--phase', type=str, default='train', help='phase for dataloading')
    self.parser.add_argument('--batch_size', type=int, default=2, help='batch size')
    self.parser.add_argument('--batch_size_test', type=int, default=3, help='batch size_test')
